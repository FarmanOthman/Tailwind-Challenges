    ...
    <div className='min-h-[89vh] '>
      <div className="flex flex-col lg:flex-row items-end justify-between  bg-transparent gap-3 lg:gap-8 p-4 lg:pt-36">
        ...
        <div className="flex items-baseline lg:self-end justify-end w-full lg:w-auto">
          <div className="flex flex-col lg:flex-row items-center justify-center gap-4 lg:gap-8 backdrop-blur-sm bg-white/10 px-6 py-6 lg:px-10 lg:py-0 w-full lg:w-auto">
...
=======
    <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen bg-transparent gap-3 lg:gap-8 p-4 lg:p-0">
      {/* Left Section */}
      <div className="flex flex-col gap-8 lg:gap-10 lg:ml-20 max-w-[20rem] items-start w-full lg:w-auto">
        <div className="flex flex-col gap-5 w-full">
          <h1 className="text-4xl lg:text-4xl font-bold text-left whitespace-pre-line">
      ...
      {/* Right Section */}
      <div className="flex items-baseline justify-end w-full lg:w-auto">
...
>>>>>>> ebfd74a520d04d48419865f14dc24986bfb4fa22
        </div>
      </div>
    </div>
  );
